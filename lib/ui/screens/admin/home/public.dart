...
import 'package:community_support/ui/screens/admin/home/user_view.dart';
import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';
import 'package:intl/intl.dart';

class PublicUsersList extends StatefulWidget {
  @override
  _PublicUsersListState createState() => _PublicUsersListState();
}

class _PublicUsersListState extends State<PublicUsersList> with AutomaticKeepAliveClientMixin {
  ...
  getPublicUser() async {
    List<QueryDocumentSnapshot> snapshot = await db.getSnapshotWithQuery('profile', 'type', ['public']);
    print(snapshot);
    return snapshot;
  }
    ...
    return ListTile(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(
          builder: (context) => UserView(arg: RegisterArguments(
